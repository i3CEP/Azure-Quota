...
* For Step wise One time Setup details, along with Snapshots, **please refer to the attached "[Aure Quota Limit & Usage Insights-Template-v1.2-(i3CEP).pdf](https://github.com/i3CEP/Azure-Quota/blob/main/Aure%20Quota%20Limit%20%26%20Usage%20Insights-Template-v1.2-(i3CEP).pdf)"**
